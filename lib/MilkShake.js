...
(function(){
	...
	MilkShake.View = MilkShake.Class.extend({
		...
		render: function(){
			...
			if(this.css != undefined){
				for(prop in this.css){
					cssprop = prop.replace(/_/g, "-");
					this.view.css(cssprop, this.css[prop]);
				}
			}
			return this.view;
		},
	...
	// CSS Styles
	MilkShake.Styles = {
		border_radius: function(px){
			return {
				_webkit_border_radius: px,
				_moz_border_radius: px,
				border_radius: px
			}
		},
		inner_shadow: function(px){
			return {
				_moz_box_shadow:    "inset 0 0 " + px + " #000000",
				_webkit_box_shadow: "inset 0 0 " + px + " #000000",
				box_shadow:         "inset 0 0 " + px + " #000000"
			}
		}
	}
})();